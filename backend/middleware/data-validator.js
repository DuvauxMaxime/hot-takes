...
module.exports = (req, res, next) => {
    ...
    if (!validator.matches(data.name, /^[a-zA-Z0-9 -]*$/) || data.name.trim().length === 0) {
    ...
    } if (!validator.matches(data.manufacturer, /^[a-zA-Z0-9 -]*$/) || data.manufacturer.trim().length === 0) {
    ...
    } if (!validator.matches(data.description, /^[a-zA-Z0-9 -]*$/) || data.description.trim().length === 0) {
    ...
    } if (!validator.matches(data.mainPepper, /^[a-zA-Z0-9 -]*$/) || data.mainPepper.trim().length === 0) {
